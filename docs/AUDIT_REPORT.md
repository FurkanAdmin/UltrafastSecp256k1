...
> **⚠ HISTORICAL BASELINE — DO NOT CITE AS CURRENT STATE ⚠**
...
> For current benchmark data see [`docs/bench_unified_2026-05-21_gcc14_x86-64.json`](bench_unified_2026-05-21_gcc14_x86-64.json).
...
> See [AUDIT_COVERAGE.md](AUDIT_COVERAGE.md) for current counts (maintained dynamically by `ci/sync_module_count.py`). At time of this snapshot: 379 modules, ~1,000,000+ checks, 267 exploit PoC tests, 0 failures.
...
| Exploit PoC tests | — | 267 exploit-PoC modules (see [AUDIT_COVERAGE.md](AUDIT_COVERAGE.md)) |
