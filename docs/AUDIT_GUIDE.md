...
### What It Tests ( 133 non-exploit modules + 273 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 406 modules, 8 sections)
...
### Metal Audit Runner ( 406 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 406 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 406 modules) |
