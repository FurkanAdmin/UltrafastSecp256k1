...
### What It Tests ( 115 non-exploit modules + 267 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 382 modules, 8 sections)
...
### Metal Audit Runner ( 382 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 382 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 382 modules) |
