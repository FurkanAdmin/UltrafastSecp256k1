...
### What It Tests ( 119 non-exploit modules + 269 exploit PoC tests + standalone audit surfaces)
...
### OpenCL Audit Runner ( 388 modules, 8 sections)
...
### Metal Audit Runner ( 388 modules, 8 sections)
...
| `opencl/src/opencl_audit_runner.cpp` | OpenCL GPU audit runner ( 388 modules) |
| `metal/src/metal_audit_runner.mm` | Metal GPU audit runner ( 388 modules) |
