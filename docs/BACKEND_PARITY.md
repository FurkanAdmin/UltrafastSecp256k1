...
| **Audit runner** | `unified_audit_runner` (60 non-exploit + 267 exploit PoCs = 249 modules) | `gpu_audit_runner` ( 383 modules) | `opencl_audit_runner` ( 383 modules) | `metal_audit_runner` ( 383 modules) |
