...
**Last updated**: 2026-04-21 | **Version**: 4.1.0
...
| **Audit runner** | `unified_audit_runner` (60 non-exploit + 272 exploit PoCs = 249 modules) | `gpu_audit_runner` ( 404 modules) | `opencl_audit_runner` ( 404 modules) | `metal_audit_runner` ( 404 modules) |
