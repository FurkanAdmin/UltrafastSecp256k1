...
| **Audit runner** | `unified_audit_runner` (60 non-exploit + 268 exploit PoCs = 249 modules) | `gpu_audit_runner` ( 384 modules) | `opencl_audit_runner` ( 384 modules) | `metal_audit_runner` ( 384 modules) |
