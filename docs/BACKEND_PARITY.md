...
| **Audit runner** | `unified_audit_runner` (60 non-exploit + 265 exploit PoCs = 249 modules) | `gpu_audit_runner` ( 379 modules) | `opencl_audit_runner` ( 379 modules) | `metal_audit_runner` ( 379 modules) |
