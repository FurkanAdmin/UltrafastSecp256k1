...
- 273 exploit PoCs security probes covering 20+ CVE/attack classes — all passing
...
# === ONE-COMMAND FULL AUDIT ( 416 modules, 9 failure classes, ~10 min) ===
...
# Exploit PoC security probes (273 probes)
