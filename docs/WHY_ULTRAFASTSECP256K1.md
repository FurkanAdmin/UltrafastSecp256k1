...
| Exploit tests | 258 PoC files, 263 registered modules, 0 failures |
...
| Exploit PoC tests | 263 dedicated adversarial PoC modules across 20+ coverage categories (`audit/test_exploit_*.cpp`) | 263 wired, 0 failures |
...
| **Total (audit runner)** | **unified_audit_runner** across 112 non-exploit modules + 263 exploit-PoC modules (371 total) | **~1,000,000+** |
...
All 112 non-exploit audit modules across all tested platforms return **AUDIT-READY**. Zero failures.
