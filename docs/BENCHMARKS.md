...
> **x86-64 (i5-14400F): 2026-05-21** GCC 14.2.0, turbo status unknown (sysfs not available; taskset -c 0 nice -20 applied), core 0 pinned, 500 warmup/op, 11-pass IQR median  
> Canonical JSON: `docs/bench_unified_2026-05-21_gcc14_x86-64.json` (machine-generated by `bench_unified --json`; `generated_by` field present)  
> Other platforms: pending fresh controlled runs.

x86-64: GCC 14.2.0 · i5-14400F · 2.496 GHz · turbo unknown · core 0 pinned · **11-pass IQR** · 2026-05-21

| Platform | Field Mul | Generator Mul | Scalar Mul (k·P) | ECDSA Verify | Verify vs lib (warm-cache) | CT Sign vs lib |
|----------|-----------|---------------|------------|-------------|---------------|----------------|
| x86-64 (i5-14400F) | 10.5 ns | — | — | — | warm-cache (64-key pool): see below | **1.27× ECDSA · 1.13× Schnorr** (turbo lock unconfirmed) |
...
|--------|--------------------|
| Field Mul, Generator Mul, Scalar Mul, ECDSA Verify | `docs/bench_unified_2026-05-21_gcc14_x86-64.json` |
| CT Sign vs lib (ECDSA 1.27×, Schnorr 1.13× — turbo lock unconfirmed) | `docs/bench_unified_2026-05-21_gcc14_x86-64.json` |
| Verify vs lib (warm-cache) | `docs/bench_unified_2026-05-21_gcc14_x86-64.json` |
...
**P1-PERF-001 (2026-05-12, diagnostic — gcc -O2 only, not Release+LTO):** `secp256k1_schnorrsig_verify` unique-pubkey path (ConnectBlock workload).
...
**~16% faster** (ranges non-overlapping). Conditions: i5-14400F, gcc -O2 (not Release+LTO), taskset -c 0, performance governor, 2048 unique pubkeys (forces lift_x cache misses), 5 runs × 10 rounds each.
Note: Re-measure at Release+LTO to confirm the improvement holds at production build settings before citing as release-grade.
