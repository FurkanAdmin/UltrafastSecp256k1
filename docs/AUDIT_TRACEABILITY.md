...
**UltrafastSecp256k1 v4.0.0** -- Evidence-Based Correctness & Security Mapping
...
- CUDA: `src/cuda/src/gpu_audit_runner.cu` ( 383 modules)
- OpenCL: `opencl/src/opencl_audit_runner.cpp` ( 383 modules)
- Metal: `metal/src/metal_audit_runner.mm` ( 383 modules)
