...
**UltrafastSecp256k1 v4.1.0** -- Evidence-Based Correctness & Security Mapping
...
- CUDA: `src/cuda/src/gpu_audit_runner.cu` ( 419 modules)
- OpenCL: `opencl/src/opencl_audit_runner.cpp` ( 419 modules)
- Metal: `metal/src/metal_audit_runner.mm` ( 419 modules)
