...
- CUDA: `src/cuda/src/gpu_audit_runner.cu` ( 416 modules)
- OpenCL: `opencl/src/opencl_audit_runner.cpp` ( 416 modules)
- Metal: `metal/src/metal_audit_runner.mm` ( 416 modules)
