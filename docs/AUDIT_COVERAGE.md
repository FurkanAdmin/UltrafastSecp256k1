...
| Audit modules | 408 across 9 failure classes |
...
**Verdict**: **CAAS Self-Audit Verdict: AUDIT-READY (self-generated continuous audit; no external third-party security audit has been completed)** -- 408 modules, 9 failure classes
...
|----------------------|---------------------------------------------|
| Audit Sections       | 8                                           |
| Audit Modules        | 135 (non-exploit modules) |
| **Exploit PoC Tests** | **273 tests across 20+ attack categories** (`audit/test_exploit_*.cpp`) |
...
*Generated from unified_audit_runner v4.1.0 output + CI workflow analysis. Last updated 2026-04-01.*
